# USAGE
# python3 bw2color_image.py --image images/satellite.JPEG --prototxt models/colorization_deploy_v2.prototxt --model models/colorization_release_v2.caffemodel --points models/pts_in_hull.npy
...
cv2.imwrite('../../static/images/radarsat1/colorized/' + filename, colorized) 
